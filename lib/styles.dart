...
class TextStyles {
  ...
  static const TextStyle arial = const TextStyle(fontFamily: Fonts.arial, fontWeight: FontWeight.w400, height: 1, color: Colors.black);
  static const TextStyle chianti = const TextStyle(fontFamily: Fonts.chianti, fontWeight: FontWeight.w400, height: 1);
